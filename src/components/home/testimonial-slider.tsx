  ...
  return (
    <div className="w-full max-w-3xl mx-auto text-center min-h-80">
      ...
      <div className="relative h-32 ">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[480px] h-[480px] pointer-events-none before:absolute before:inset-0 before:bg-gradient-to-b before:from-red-color/50 before:via-red-color/10 before:via-25% before:to-indigo-500/0 before:to-75% before:rounded-full before:-z-10">
          <div className="h-32 [mask-image:_linear-gradient(0deg,transparent,theme(colors.white)_20%,theme(colors.white))]">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <Image
                  className="relative top-3 object-contain  left-1/2 -translate-x-1/2 rounded-full"
                  src={testimonial.img}
                  width={80}
                  height={80}
        ...
        {testimonials.map((testimonial, index) => (
          <button
            ...
            className={`inline-flex justify-center whitespace-nowrap rounded-full px-3 py-1.5 m-1.5 text-xs shadow-sm focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 transition-colors duration-150 ${
              active === index
                ? "bg-red-color/50 text-white shadow-indigo-950/10"
